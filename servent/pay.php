	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Find You Dream Servent For Hire</h2>
			</section>
			...
			<ul class="properties_list">
				...
				<?php
						...
						if(isset($_POST['pay'])){
							...
							$id=$_GET['id'];
							$price=$_GET['price'];
							$qry = "UPDATE client SET mpesa = '$mpesa',servent_id='$id',status='pending' WHERE id_no = '$id_no'";
